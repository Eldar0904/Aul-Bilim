...
DISTRICT_LABELS = [
    ...
    {"kk": "Жітіқара ауданы", "en": "Zhitikara District", "slug": "zhitikara"},
    {"kk": "Камысты ауданы", "en": "Kamysty District", "slug": "kamysty"},
    {"kk": "Қарабалық ауданы", "en": "Qarabalyq District", "slug": "qarabalyq"},
    {"kk": "Қарасу ауданы", "en": "Qarasu District", "slug": "qarasu"},
    {"kk": "Қостанай ауданы", "en": "Kostanay District", "slug": "kostanay-district"},
    {"kk": "Меңдіқара ауданы", "en": "Mendykara District", "slug": "mendykara"},
    {"kk": "Наурызым ауданы", "en": "Nauryzym District", "slug": "nauryzym"},
    {"kk": "Б. Майлин ауданы", "en": "B. Mailin District", "slug": "mailin"},
    {"kk": "Сарыкөл ауданы", "en": "Sarykol District", "slug": "sarykol"},
    {"kk": "Ұзынкөл ауданы", "en": "Uzunkol District", "slug": "uzunkol"},
    {"kk": "Фёдоров ауданы", "en": "Fedorov District", "slug": "fedorov"},
